...
Route::post('/pendaftaran-delete', [App\Http\Controllers\pendaftaranController::class, 'destroy'])->name('pendaftaran.destroy');
...
Route::get('/jadwal-delete/{id}', [App\Http\Controllers\jadwalController::class, 'destroy'])->name('jadwal.destroy');
