...
<body>
    ...
    <section id="hero">
        <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
            ...
            <p class="mb-4 pb-0">The esports industry is flourishing and the gaming population is exponentially
                increasing.</p>
        ...
        <section id="about">
            <div class="container" data-aos="fade-up">
                <div class="row">
                    <div class="col-lg-6">
                        <h2>About Us</h2>
                        <p>Battle Of Squad (BOS) merupakan Event Organizer penyedia layanan dan jasa bidang olahraga
                            elektronik (E-Sport) . Dengan target sebagai penyelenggara event berkala yang sesuai target
                            pasar dan memberikan wadah bagi penikmat dunia E-Sport.</p>
                    </div>
                    <div class="col-lg-3">
                        <h3>Where</h3>
                ...
                <div class="tab-content row justify-content-center" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div role="tabpanel" class="col-lg-9 tab-pane fade show active" id="day-1">
                        ...
                        <div class="row schedule-item">
                            <div class="col-md-2"><time>{{$jadwal->tanggal_mulai}}</time><span>
                                </span><time>{{$jadwal->tanggal_selesai}}</time></div>
                            <div class="col-md-10">
                                <div class="speaker">
                                    <img src="{{ url('/gambar/'.$jadwal->gambar) }}">
                                </div>
                                <h4>{{$jadwal->nama_event}}</h4>
